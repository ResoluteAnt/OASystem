...
layui.use(
  ...
  table.render({
    elem: '#demo'
    ,height: 580
    ,url: '${ctxPath}/Reimburse/jsonMyInitiate?initiator=${user.id}' //数据接口
    ,title: '待我审批请假表'
    ,page: true //开启分页
    ...
    ,cols: [[     //表头
       ...
       ,{field:'procInstId', title:'流程实例ID', width:95}
       ,{field:'assigneeName', title:'当前办理人', width:95}
       ,{field:'type', title:'报销类型', width:85}
       ,{field:'createTime', title:'创建日期', width:125}
       ,{field:'finishTime', title:'完成日期', width:125}
       ,{field:'status', title:'流程状态', width:85}
  ...
  table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
    ...
    if(layEvent === 'detail'){
      ...
      window.location = '${ctxPath}/Reimburse/taskDetail?taskId='+ data['taskId'];
