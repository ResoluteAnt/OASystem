...
layui.use(
  ...
  table.render({
    elem: '#demo'
    ,height: 580
    ,url: '${ctxPath}/Reimburse/jsonWaitMyApprove?assigneeId=${user.id}' //数据接口
    ,title: '待我审批报销表'
    ,page: true //开启分页
